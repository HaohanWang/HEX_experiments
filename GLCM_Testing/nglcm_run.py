...
def train(args, Xtrain,Ytrain, Xval, Yval, Xtest, Ytest, ztrain,zval,ztest,corr,use_hex=True):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(args.epochs):
            ...
            np.save('results/labels_nglcm'+str(epoch), Label)
            np.save('results/patterns_nglcm'+str(epoch), Pattern)
            np.save('results/representations_nglcm'+str(epoch), Reps)
